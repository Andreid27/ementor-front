...
|[**getInactiveStudentsForProfessor**](#getinactivestudentsforprofessor) | **GET** /student-professor-relationships/professor/{professorId}/inactive-students | Get inactive students for a professor with pagination, filtering, and sorting|
...
|[**getRelationshipsByStudentIds**](#getrelationshipsbystudentids) | **POST** /student-professor-relationships/batch-by-student-ids | Get relationships for specific student IDs|
...
# **getInactiveStudentsForProfessor**
> PageStudentProfessorRelationshipDTO getInactiveStudentsForProfessor()
...
let modifiedAfter: string; // (optional) (default to undefined)
let modifiedBefore: string; // (optional) (default to undefined)
let page: number; // (optional) (default to 0)
let size: number; // (optional) (default to 20)
let sort: string; // (optional) (default to undefined)

const { status, data } = await apiInstance.getInactiveStudentsForProfessor(
    professorId,
    generation,
    createdAfter,
    createdBefore,
...
| **modifiedAfter** | [**string**] |  | (optional) defaults to undefined|
| **modifiedBefore** | [**string**] |  | (optional) defaults to undefined|
...
**PageStudentProfessorRelationshipDTO**
...
|-------------|-------------|------------------|
|**403** | Access denied |  -  |
|**200** | Inactive students retrieved successfully |  -  |
|**400** | Invalid generation format or date range |  -  |
...
> Array<StudentProfessorRelationshipDTO> getRelationshipsByStudentIds(getRelationshipsByStudentIdsRequest)
...
let getRelationshipsByStudentIdsRequest: GetRelationshipsByStudentIdsRequest; //

const { status, data } = await apiInstance.getRelationshipsByStudentIds(
    getRelationshipsByStudentIdsRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **getRelationshipsByStudentIdsRequest** | **GetRelationshipsByStudentIdsRequest**|  | |
...
|**403** | Access denied |  -  |
|**400** | Invalid request or too many IDs |  -  |
