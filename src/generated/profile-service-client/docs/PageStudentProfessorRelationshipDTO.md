...
**content** | [**Array&lt;StudentProfessorRelationshipDTO&gt;**](StudentProfessorRelationshipDTO.md) |  | [optional] [default to undefined]
...
```typescript
import { PageStudentProfessorRelationshipDTO } from 'ementor-api-client';

const instance: PageStudentProfessorRelationshipDTO = {
    totalPages,
    totalElements,
    pageable,
    first,
