...
export type BankTransferPaymentStatusEnum =
  (typeof BankTransferPaymentStatusEnum)[keyof typeof BankTransferPaymentStatusEnum]
...
export type BankTransferPaymentDTOStatusEnum =
  (typeof BankTransferPaymentDTOStatusEnum)[keyof typeof BankTransferPaymentDTOStatusEnum]
...
export type PaymentEventAssociationAllocationStrategyEnum =
  (typeof PaymentEventAssociationAllocationStrategyEnum)[keyof typeof PaymentEventAssociationAllocationStrategyEnum]
...
export type ProfessorPlatformIntegrationAuthMethodEnum =
  (typeof ProfessorPlatformIntegrationAuthMethodEnum)[keyof typeof ProfessorPlatformIntegrationAuthMethodEnum]
...
export type ProfessorPlatformIntegrationStatusEnum =
  (typeof ProfessorPlatformIntegrationStatusEnum)[keyof typeof ProfessorPlatformIntegrationStatusEnum]
...
export type WalletBalanceChangeDTOChangeTypeEnum =
  (typeof WalletBalanceChangeDTOChangeTypeEnum)[keyof typeof WalletBalanceChangeDTOChangeTypeEnum]
...
export type WalletBalanceChangeDTOReferenceTypeEnum =
  (typeof WalletBalanceChangeDTOReferenceTypeEnum)[keyof typeof WalletBalanceChangeDTOReferenceTypeEnum]
...
export const AdminPaymentControllerApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getAllPayments: async (
      page?: number,
      size?: number,
      status?: GetAllPaymentsStatusEnum,
      startDate?: string,
      endDate?: string,
    ...
    getEventDebtSummary1: async (eventId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/admin/payment-system/fifo/events/{eventId}/debt-summary`.replace(
        `{${'eventId'}}`,
    ...
    getPaymentAllocations: async (paymentId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/admin/payment-system/fifo/payments/{paymentId}/allocations`.replace(
        `{${'paymentId'}}`,
    ...
    getPaymentsByPayer: async (
      ...
      const localVarPath = `/admin/payment-system/payments/payer/{payerId}`.replace(
        `{${'payerId'}}`,
        encodeURIComponent(String(payerId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
    ...
    getPaymentsByProfessor: async (
      ...
      const localVarPath = `/admin/payment-system/payments/professor/{professorId}`.replace(
        `{${'professorId'}}`,
     ...
     * @throws {RequiredError}
     */
    getProfessorPaymentSummary1: async (
      professorId: string,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'professorId' is not null or undefined
      assertParamExists('getProfessorPaymentSummary1', 'professorId', professorId)
      const localVarPath = `/admin/payment-system/fifo/professors/{professorId}/payment-summary`.replace(
        `{${'professorId'}}`,
        encodeURIComponent(String(professorId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    recalculateUserWallet: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/admin/payment-system/wallets/{userId}/recalculate`.replace(
        `{${'userId'}}`,
    ...
    syncStudentSoloClients: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/admin/payment-system/sync-student-solo-clients/{userId}`.replace(
        `{${'userId'}}`,
        encodeURIComponent(String(userId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AdminPaymentControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getAllPayments(
      ...
      endDate?: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageBankTransferPaymentDTO>> {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getAllPayments']?.[localVarOperationServerIndex]?.url
    ...
    async getAllPendingPayments(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BankTransferPaymentDTO>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getAllPendingPayments(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getAllPendingPayments']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getAllWallets(
      ...
      size?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PageWalletDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getAllWallets(page, size, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getAllWallets']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getEventDebtSummary1(
      eventId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventDebtSummaryDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getEventDebtSummary1(eventId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getEventDebtSummary1']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getFIFOStatistics(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FIFOSystemStatisticsDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getFIFOStatistics(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getFIFOStatistics']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPaymentAllocations(
      paymentId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentDetailDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPaymentAllocations(paymentId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getPaymentAllocations']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getPaymentSystemStatistics(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentSystemStatisticsDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPaymentSystemStatistics(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getPaymentSystemStatistics']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPaymentsByPayer(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getPaymentsByPayer']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPaymentsByProfessor(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getPaymentsByProfessor']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getProfessorPaymentSummary1(
      professorId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProfessorPaymentSummaryDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getProfessorPaymentSummary1(professorId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getProfessorPaymentSummary1']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getRecentPayments(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getRecentPayments']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getStudentDebtSummary1(
      studentId: string,
      professorId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentDebtSummaryDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentDebtSummary1(studentId, professorId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getStudentDebtSummary1']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTotalDebt1(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.getTotalDebt1']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async recalculateAllWallets(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkWalletRecalculationResultDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.recalculateAllWallets(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.recalculateAllWallets']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async recalculateUserWallet(
      userId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletRecalculationResultDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.recalculateUserWallet(userId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.recalculateUserWallet']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async syncStudentSoloClients(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminPaymentControllerApi.syncStudentSoloClients']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const AdminPaymentControllerApiFactory = function (
  ...
  return {
     ...
     */
    getAllPayments(
      requestParameters: AdminPaymentControllerApiGetAllPaymentsRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PageBankTransferPaymentDTO> {
      return localVarFp
        .getAllPayments(
     ...
     */
    getAllWallets(
      requestParameters: AdminPaymentControllerApiGetAllWalletsRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PageWalletDTO> {
      return localVarFp
        .getAllWallets(requestParameters.page, requestParameters.size, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getEventDebtSummary1(
      requestParameters: AdminPaymentControllerApiGetEventDebtSummary1Request,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<EventDebtSummaryDTO> {
      return localVarFp
        .getEventDebtSummary1(requestParameters.eventId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getPaymentAllocations(
      requestParameters: AdminPaymentControllerApiGetPaymentAllocationsRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PaymentDetailDTO> {
      return localVarFp
        .getPaymentAllocations(requestParameters.paymentId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    getPaymentsByPayer(
      requestParameters: AdminPaymentControllerApiGetPaymentsByPayerRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PageBankTransferPaymentDTO> {
      return localVarFp
        .getPaymentsByPayer(requestParameters.payerId, requestParameters.page, requestParameters.size, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getPaymentsByProfessor(
      requestParameters: AdminPaymentControllerApiGetPaymentsByProfessorRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PageBankTransferPaymentDTO> {
      return localVarFp
        .getPaymentsByProfessor(requestParameters.professorId, requestParameters.page, requestParameters.size, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getProfessorPaymentSummary1(
      requestParameters: AdminPaymentControllerApiGetProfessorPaymentSummary1Request,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ProfessorPaymentSummaryDTO> {
      return localVarFp
        .getProfessorPaymentSummary1(requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    getRecentPayments(
      requestParameters: AdminPaymentControllerApiGetRecentPaymentsRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<BankTransferPaymentDTO>> {
    ...
    getStudentDebtSummary1(
      requestParameters: AdminPaymentControllerApiGetStudentDebtSummary1Request,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<StudentDebtSummaryDTO> {
      return localVarFp
        .getStudentDebtSummary1(requestParameters.studentId, requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    getTotalDebt1(
      requestParameters: AdminPaymentControllerApiGetTotalDebt1Request,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<number> {
      return localVarFp
        .getTotalDebt1(requestParameters.studentId, requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    recalculateUserWallet(
      requestParameters: AdminPaymentControllerApiRecalculateUserWalletRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<WalletRecalculationResultDTO> {
      return localVarFp
        .recalculateUserWallet(requestParameters.userId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    syncStudentSoloClients(
      requestParameters: AdminPaymentControllerApiSyncStudentSoloClientsRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<string> {
      return localVarFp
        .syncStudentSoloClients(requestParameters.userId, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export class AdminPaymentControllerApi extends BaseAPI implements AdminPaymentControllerApiInterface {
  ...
  public getAllPayments(
    ...
    return AdminPaymentControllerApiFp(this.configuration)
      .getAllPayments(
        requestParameters.page,
        requestParameters.size,
        requestParameters.status,
  ...
  public getPaymentSystemStatistics(options?: RawAxiosRequestConfig) {
    return AdminPaymentControllerApiFp(this.configuration)
      .getPaymentSystemStatistics(options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof AdminPaymentControllerApi
   */
  public getProfessorPaymentSummary1(
    requestParameters: AdminPaymentControllerApiGetProfessorPaymentSummary1Request,
    options?: RawAxiosRequestConfig
  ) {
    return AdminPaymentControllerApiFp(this.configuration)
  ...
  public getRecentPayments(
    ...
    return AdminPaymentControllerApiFp(this.configuration)
      .getRecentPayments(requestParameters.days, options)
      .then(request => request(this.axios, this.basePath))
  }
...
export const EventsControllerApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getEventOccurrenceByEventAttendeeId: async (
      eventAttendeeId: string,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/events/event-occurrence/{eventAttendeeId}`.replace(
        `{${'eventAttendeeId'}}`,
        encodeURIComponent(String(eventAttendeeId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
...
export const EventsControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getEventOccurrenceByEventAttendeeId(
      eventAttendeeId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventOccurrenceDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getEventOccurrenceByEventAttendeeId(
        eventAttendeeId,
        options
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['EventsControllerApi.getEventOccurrenceByEventAttendeeId']?.[localVarOperationServerIndex]
          ?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async getMyRecurringSeries(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RecurringSeriesDTO>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyRecurringSeries(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['EventsControllerApi.getMyRecurringSeries']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const EventsControllerApiFactory = function (
  ...
  return {
    ...
    getEventOccurrenceByEventAttendeeId(
      requestParameters: EventsControllerApiGetEventOccurrenceByEventAttendeeIdRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<EventOccurrenceDTO> {
      return localVarFp
        .getEventOccurrenceByEventAttendeeId(requestParameters.eventAttendeeId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
...
export class EventsControllerApi extends BaseAPI implements EventsControllerApiInterface {
   ...
   * @memberof EventsControllerApi
   */
  public getEventOccurrenceByEventAttendeeId(
    requestParameters: EventsControllerApiGetEventOccurrenceByEventAttendeeIdRequest,
    options?: RawAxiosRequestConfig
  ) {
    return EventsControllerApiFp(this.configuration)
...
export const FIFOAllocationApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getEventDebtSummary: async (eventId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/fifo/events/{eventId}/debt-summary`.replace(
        `{${'eventId'}}`,
        encodeURIComponent(String(eventId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPaymentDetails: async (paymentId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/fifo/payments/{paymentId}/details`.replace(
        `{${'paymentId'}}`,
        encodeURIComponent(String(paymentId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getProfessorPaymentSummaryAdmin: async (
      professorId: string,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'professorId' is not null or undefined
      assertParamExists('getProfessorPaymentSummaryAdmin', 'professorId', professorId)
      const localVarPath = `/fifo/payments/professor/{professorId}/summary`.replace(
        `{${'professorId'}}`,
        encodeURIComponent(String(professorId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getStudentDebtSummary: async (professorId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/fifo/debt/student/professor/{professorId}`.replace(
        `{${'professorId'}}`,
        encodeURIComponent(String(professorId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getStudentDebtSummaryAdmin: async (
      studentId: string,
      professorId: string,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
    ...
    getTotalDebt: async (professorId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/fifo/debt/total/professor/{professorId}`.replace(
        `{${'professorId'}}`,
        encodeURIComponent(String(professorId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    simulatePaymentAllocation: async (
      professorId: string,
      amount: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
...
export const FIFOAllocationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getEventDebtSummary(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getEventDebtSummary']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPaymentDetails(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getPaymentDetails']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getProfessorPaymentSummary(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProfessorPaymentSummaryDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getProfessorPaymentSummary(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getProfessorPaymentSummary']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getProfessorPaymentSummaryAdmin(
      professorId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProfessorPaymentSummaryDTO>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getProfessorPaymentSummaryAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getStudentDebtSummary(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getStudentDebtSummary']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getStudentDebtSummaryAdmin(
      studentId: string,
      professorId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentDebtSummaryDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getStudentDebtSummaryAdmin(
        studentId,
        professorId,
        options
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getStudentDebtSummaryAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTotalDebt(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getTotalDebt']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTotalDebtAdmin(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.getTotalDebtAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async healthCheck(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.healthCheck']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async simulatePaymentAllocation(
      professorId: string,
      amount: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentDetailDTO>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['FIFOAllocationApi.simulatePaymentAllocation']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const FIFOAllocationApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getEventDebtSummary(
      requestParameters: FIFOAllocationApiGetEventDebtSummaryRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<EventDebtSummaryDTO> {
      return localVarFp
        .getEventDebtSummary(requestParameters.eventId, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Comprehensive payment details including FIFO allocation breakdown
     ...
     */
    getPaymentDetails(
      requestParameters: FIFOAllocationApiGetPaymentDetailsRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PaymentDetailDTO> {
      return localVarFp
        .getPaymentDetails(requestParameters.paymentId, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Comprehensive payment analytics for current professor including allocation details
    ...
    getProfessorPaymentSummaryAdmin(
      requestParameters: FIFOAllocationApiGetProfessorPaymentSummaryAdminRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ProfessorPaymentSummaryDTO> {
      return localVarFp
        .getProfessorPaymentSummaryAdmin(requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Returns comprehensive debt breakdown including event details, payment history, and outstanding balances
    ...
    getStudentDebtSummary(
      requestParameters: FIFOAllocationApiGetStudentDebtSummaryRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<StudentDebtSummaryDTO> {
      return localVarFp
        .getStudentDebtSummary(requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Administrative endpoint for viewing student debt details
    ...
    getStudentDebtSummaryAdmin(
      requestParameters: FIFOAllocationApiGetStudentDebtSummaryAdminRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<StudentDebtSummaryDTO> {
      return localVarFp
        .getStudentDebtSummaryAdmin(requestParameters.studentId, requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Returns the total outstanding debt amount for current student with specific professor
     ...
     */
    getTotalDebt(
      requestParameters: FIFOAllocationApiGetTotalDebtRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<number> {
     ...
     */
    getTotalDebtAdmin(
      requestParameters: FIFOAllocationApiGetTotalDebtAdminRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<number> {
      return localVarFp
        .getTotalDebtAdmin(requestParameters.studentId, requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Simple health check to verify FIFO allocation service availability
    ...
    simulatePaymentAllocation(
      requestParameters: FIFOAllocationApiSimulatePaymentAllocationRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PaymentDetailDTO> {
      return localVarFp
        .simulatePaymentAllocation(requestParameters.professorId, requestParameters.amount, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export class FIFOAllocationApi extends BaseAPI implements FIFOAllocationApiInterface {
   ...
   */
  public getEventDebtSummary(
    requestParameters: FIFOAllocationApiGetEventDebtSummaryRequest,
    options?: RawAxiosRequestConfig
  ) {
    return FIFOAllocationApiFp(this.configuration)
      .getEventDebtSummary(requestParameters.eventId, options)
      .then(request => request(this.axios, this.basePath))
  }
  ...
  public getProfessorPaymentSummary(options?: RawAxiosRequestConfig) {
    return FIFOAllocationApiFp(this.configuration)
      .getProfessorPaymentSummary(options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof FIFOAllocationApi
   */
  public getProfessorPaymentSummaryAdmin(
    requestParameters: FIFOAllocationApiGetProfessorPaymentSummaryAdminRequest,
    options?: RawAxiosRequestConfig
  ) {
    return FIFOAllocationApiFp(this.configuration)
   ...
   * @memberof FIFOAllocationApi
   */
  public getStudentDebtSummaryAdmin(
    requestParameters: FIFOAllocationApiGetStudentDebtSummaryAdminRequest,
    options?: RawAxiosRequestConfig
  ) {
    return FIFOAllocationApiFp(this.configuration)
  ...
  public getTotalDebt(requestParameters: FIFOAllocationApiGetTotalDebtRequest, options?: RawAxiosRequestConfig) {
    return FIFOAllocationApiFp(this.configuration)
      .getTotalDebt(requestParameters.professorId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof FIFOAllocationApi
   */
  public simulatePaymentAllocation(
    requestParameters: FIFOAllocationApiSimulatePaymentAllocationRequest,
    options?: RawAxiosRequestConfig
  ) {
    return FIFOAllocationApiFp(this.configuration)
...
export const InvoiceControllerApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    downloadInvoiceById: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/invoices/{id}/download`.replace(`{${'id'}}`, encodeURIComponent(String(id)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const InvoiceControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async downloadInvoiceById(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['InvoiceControllerApi.downloadInvoiceById']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMyInvoices(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InvoiceDTO>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyInvoices(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['InvoiceControllerApi.getMyInvoices']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const InvoiceControllerApiFactory = function (
  ...
  return {
     ...
     */
    downloadInvoiceById(
      requestParameters: InvoiceControllerApiDownloadInvoiceByIdRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<File> {
...
export class InvoiceControllerApi extends BaseAPI implements InvoiceControllerApiInterface {
   ...
   */
  public downloadInvoiceById(
    requestParameters: InvoiceControllerApiDownloadInvoiceByIdRequest,
    options?: RawAxiosRequestConfig
  ) {
    return InvoiceControllerApiFp(this.configuration)
      .downloadInvoiceById(requestParameters.id, options)
      .then(request => request(this.axios, this.basePath))
  }
...
export const PaymentControllerApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    canConfirmPayment: async (paymentId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/payment/can-confirm/{paymentId}`.replace(
        `{${'paymentId'}}`,
        encodeURIComponent(String(paymentId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getConfirmationResult: async (paymentId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/payment/confirmation-result/{paymentId}`.replace(
        `{${'paymentId'}}`,
        encodeURIComponent(String(paymentId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPaymentById: async (paymentId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/payment/{paymentId}`.replace(`{${'paymentId'}}`, encodeURIComponent(String(paymentId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getPaymentForConfirmation: async (paymentId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/payment/confirmation/{paymentId}`.replace(
        `{${'paymentId'}}`,
        encodeURIComponent(String(paymentId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getProfessorPaymentInfo: async (professorId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/payment/professor/{professorId}/info`.replace(
        `{${'professorId'}}`,
        encodeURIComponent(String(professorId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const PaymentControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async canConfirmPayment(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.canConfirmPayment']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async confirmPayment(
      paymentConfirmationRequest: PaymentConfirmationRequest,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BankTransferPaymentDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.confirmPayment(paymentConfirmationRequest, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.confirmPayment']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async createPayment(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.createPayment']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async generateReference(
      generateReferenceRequest: GenerateReferenceRequest,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentReferenceDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.generateReference(generateReferenceRequest, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.generateReference']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getConfirmationHistory(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getConfirmationHistory']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getConfirmationResult(
      paymentId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentConfirmationResultDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getConfirmationResult(paymentId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getConfirmationResult']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMyPayments(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getMyPayments']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPaymentById(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getPaymentById']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getPaymentForConfirmation(
      paymentId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BankTransferPaymentDTO>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getPaymentForConfirmation']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPendingPayments(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getPendingPayments']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getProfessorPaymentInfo(
      professorId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProfessorPaymentInfoDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getProfessorPaymentInfo(professorId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.getProfessorPaymentInfo']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async rejectPayment(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.rejectPayment']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async validateReference(
      referenceValidationRequest: ReferenceValidationRequest,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReferenceValidationResponseDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.validateReference(referenceValidationRequest, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PaymentControllerApi.validateReference']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const PaymentControllerApiFactory = function (
  ...
  return {
     ...
     */
    canConfirmPayment(
      requestParameters: PaymentControllerApiCanConfirmPaymentRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<boolean> {
      return localVarFp
        .canConfirmPayment(requestParameters.paymentId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    confirmPayment(
      requestParameters: PaymentControllerApiConfirmPaymentRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<BankTransferPaymentDTO> {
      return localVarFp
        .confirmPayment(requestParameters.paymentConfirmationRequest, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    createPayment(
      requestParameters: PaymentControllerApiCreatePaymentRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<BankTransferPaymentDTO> {
      return localVarFp
        .createPayment(requestParameters.createPaymentRequest, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Generates a unique reference code for bank transfer payment
     ...
     */
    generateReference(
      requestParameters: PaymentControllerApiGenerateReferenceRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PaymentReferenceDTO> {
      return localVarFp
        .generateReference(requestParameters.generateReferenceRequest, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getConfirmationHistory(
      requestParameters: PaymentControllerApiGetConfirmationHistoryRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<BankTransferPaymentDTO>> {
      return localVarFp
        .getConfirmationHistory(requestParameters.startDate, requestParameters.endDate, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getConfirmationResult(
      requestParameters: PaymentControllerApiGetConfirmationResultRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<PaymentConfirmationResultDTO> {
      return localVarFp
        .getConfirmationResult(requestParameters.paymentId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    getPaymentById(
      requestParameters: PaymentControllerApiGetPaymentByIdRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<BankTransferPaymentDTO> {
    ...
    getPaymentForConfirmation(
      requestParameters: PaymentControllerApiGetPaymentForConfirmationRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<BankTransferPaymentDTO> {
      return localVarFp
        .getPaymentForConfirmation(requestParameters.paymentId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    getProfessorPaymentInfo(
      requestParameters: PaymentControllerApiGetProfessorPaymentInfoRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ProfessorPaymentInfoDTO> {
      return localVarFp
        .getProfessorPaymentInfo(requestParameters.professorId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    rejectPayment(
      requestParameters: PaymentControllerApiRejectPaymentRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<BankTransferPaymentDTO> {
      return localVarFp
        .rejectPayment(requestParameters.paymentConfirmationRequest, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    validateReference(
      requestParameters: PaymentControllerApiValidateReferenceRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ReferenceValidationResponseDTO> {
      return localVarFp
        .validateReference(requestParameters.referenceValidationRequest, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export class PaymentControllerApi extends BaseAPI implements PaymentControllerApiInterface {
  ...
  public getPaymentById(requestParameters: PaymentControllerApiGetPaymentByIdRequest, options?: RawAxiosRequestConfig) {
    return PaymentControllerApiFp(this.configuration)
      .getPaymentById(requestParameters.paymentId, options)
      .then(request => request(this.axios, this.basePath))
  }
   ...
   * @memberof PaymentControllerApi
   */
  public getPaymentForConfirmation(
    requestParameters: PaymentControllerApiGetPaymentForConfirmationRequest,
    options?: RawAxiosRequestConfig
  ) {
    return PaymentControllerApiFp(this.configuration)
   ...
   * @memberof PaymentControllerApi
   */
  public getProfessorPaymentInfo(
    requestParameters: PaymentControllerApiGetProfessorPaymentInfoRequest,
    options?: RawAxiosRequestConfig
  ) {
    return PaymentControllerApiFp(this.configuration)
...
export const WalletControllerApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getUserBalance: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/wallet/balance/user/{userId}`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getUserBalanceHistory: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/wallet/history/user/{userId}`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getUserWallet: async (userId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/wallet/user/{userId}`.replace(`{${'userId'}}`, encodeURIComponent(String(userId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const WalletControllerApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getMyBalance(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getMyBalance']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMyBalanceHistory(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletSummaryDTO>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMyBalanceHistory(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getMyBalanceHistory']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getMyWallet(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getMyWallet']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUserBalance(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getUserBalance']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUserBalanceHistory(
      userId: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WalletBalanceChangeDTO>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUserBalanceHistory(userId, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getUserBalanceHistory']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUserWallet(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getUserWallet']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getUsersWithCredit(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WalletDTO>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUsersWithCredit(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getUsersWithCredit']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
     ...
     * @throws {RequiredError}
     */
    async getUsersWithDebt(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WalletDTO>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUsersWithDebt(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['WalletControllerApi.getUsersWithDebt']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const WalletControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getUserBalance(
      requestParameters: WalletControllerApiGetUserBalanceRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<number> {
    ...
    getUserBalanceHistory(
      requestParameters: WalletControllerApiGetUserBalanceHistoryRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<WalletBalanceChangeDTO>> {
      return localVarFp
        .getUserBalanceHistory(requestParameters.userId, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
     ...
     */
    getUserWallet(
      requestParameters: WalletControllerApiGetUserWalletRequest,
      options?: RawAxiosRequestConfig
...
export class WalletControllerApi extends BaseAPI implements WalletControllerApiInterface {
  ...
  public getMyBalance(options?: RawAxiosRequestConfig) {
    return WalletControllerApiFp(this.configuration)
      .getMyBalance(options)
      .then(request => request(this.axios, this.basePath))
  }
  ...
  public getUserBalance(requestParameters: WalletControllerApiGetUserBalanceRequest, options?: RawAxiosRequestConfig) {
    return WalletControllerApiFp(this.configuration)
      .getUserBalance(requestParameters.userId, options)
      .then(request => request(this.axios, this.basePath))
  }
  ...
  public getUserWallet(requestParameters: WalletControllerApiGetUserWalletRequest, options?: RawAxiosRequestConfig) {
    return WalletControllerApiFp(this.configuration)
      .getUserWallet(requestParameters.userId, options)
      .then(request => request(this.axios, this.basePath))
  }
